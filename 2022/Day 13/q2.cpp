...
bool compare(string &packet1, string &packet2)
{
    return VerifyPackets(packet1, packet2) < 0;
}
...
int main(int argc, char const *argv[])
{
    ...
    int i = find(v.begin(), v.end(), "[[2]]") - v.begin() + 1;
    int j = find(v.begin(), v.end(), "[[6]]") - v.begin() + 1;
    cout << "Result is : " << i * j << "\n";
    return 0;
}
